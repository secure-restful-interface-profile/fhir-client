...
class ResourceServer
  ...
  def get_resource(resource, access_token)
    Rails.logger.debug "========= Getting resource at #{@server_uri}/#{resource} ========="

    response = connection.get(@server_uri + "/" + resource) do |request|
